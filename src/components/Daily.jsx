...
const TOOTH_POSITIONS = [
  ...
  { id: 'L1', name: 'ฟันกรามล่างซ้ายซี่ที่ 3 (ฟันคุดล่างซ้าย)', top: '51.5%', left: '5%', width: '13%', height: '7.5%' },
  { id: 'L2', name: 'ฟันกรามล่างซ้ายซี่ที่ 2', top: '58.5%', left: '5%', width: '12.5%', height: '7.5%' },
  { id: 'L3', name: 'ฟันกรามล่างซ้ายซี่ที่ 1', top: '65.5%', left: '6%', width: '13.5%', height: '8%' },
  { id: 'L4', name: 'ฟันกรามน้อยล่างซ้ายซี่ที่ 2', top: '73%', left: '9%', width: '12.5%', height: '7%' },
  { id: 'L5', name: 'ฟันกรามน้อยล่างซ้ายซี่ที่ 1', top: '80%', left: '13.5%', width: '12.5%', height: '7.5%' },
  { id: 'L6', name: 'ฟันเขี้ยวล่างซ้าย', top: '85.5%', left: '19%', width: '12.5%', height: '9%' },
  { id: 'L7', name: 'ฟันตัดล่างซ้ายซี่ที่ 2', top: '87%', left: '30%', width: '11%', height: '10%' },
  { id: 'L8', name: 'ฟันตัดล่างซ้ายซี่ที่ 1', top: '88.5%', left: '39.5%', width: '11%', height: '10%' },
  { id: 'L9', name: 'ฟันตัดล่างขวาซี่ที่ 1', top: '88%', left: '50.5%', width: '10.5%', height: '10.5%' },
  { id: 'L10', name: 'ฟันตัดล่างขวาซี่ที่ 2', top: '88%', left: '60.5%', width: '12%', height: '9%' },
  { id: 'L11', name: 'ฟันเขี้ยวล่างขวา', top: '85.5%', left: '70%', width: '12%', height: '9%' },
  { id: 'L12', name: 'ฟันกรามน้อยล่างขวาซี่ที่ 1', top: '80%', left: '75%', width: '13%', height: '7.5%' },
  { id: 'L13', name: 'ฟันกรามน้อยล่างขวาซี่ที่ 2', top: '73.5%', left: '80%', width: '11%', height: '7%' },
  { id: 'L14', name: 'ฟันกรามล่างขวาซี่ที่ 1', top: '66%', left: '82%', width: '11.5%', height: '7.5%' },
  { id: 'L15', name: 'ฟันกรามล่างขวาซี่ที่ 2', top: '59.5%', left: '82%', width: '12.5%', height: '7%' },
  { id: 'L16', name: 'ฟันกรามล่างขวาซี่ที่ 3 (ฟันคุดล่างขวา)', top: '52%', left: '82.5%', width: '13%', height: '8%' },
]
